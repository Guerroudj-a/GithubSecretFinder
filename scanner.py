...
####################################
# HIGH SIGNAL SECRET PATTERNS ONLY
####################################
...
def print_finding(repo_url, repo_name, branch, file_path, secret_type, match):
...
def main():
    ...
    safe_print(
        f"\n🚀 High-confidence credential scan starting ({len(repos)} repos)\n"
    )
